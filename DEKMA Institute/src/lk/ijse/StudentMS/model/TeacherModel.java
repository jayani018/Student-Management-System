...
public class TeacherModel {
    ...
    public static boolean deleteTeacher(Teacher teacher) throws SQLException, ClassNotFoundException {
    ...
    public static boolean searchTeacher(Teacher teacher) throws SQLException, ClassNotFoundException {
    ...
    public static ArrayList<Teacher> loadTeacher() throws SQLException, ClassNotFoundException {
